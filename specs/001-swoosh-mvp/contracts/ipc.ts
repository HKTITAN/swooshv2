 ...
 *
 * The real implementation lives at packages/shared/src/ipc.ts.
 * This file mirrors it as part of the spec so the contract is
 * versioned alongside the design docs. Diverging from it is a
